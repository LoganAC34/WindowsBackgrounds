...
class FrameMainApp(wx.Frame):
    def __init__(self, *args, **kwds):
        # begin wxGlade: FrameMainApp.__init__
    ...
    def window_tab_changed(self, event):  # wxGlade: FrameMainApp.<event_handler>
        print("Event handler 'window_tab_changed' not implemented!")
        event.Skip()

    def on_resize(self, event):  # wxGlade: FrameMainApp.<event_handler>
        print("Event handler 'on_resize' not implemented!")
        event.Skip()

# end of class FrameMainApp
