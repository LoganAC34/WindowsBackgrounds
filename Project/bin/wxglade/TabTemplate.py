...
class TabTemplate(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.Profile1 = wx.Panel(self, wx.ID_ANY)
        """ Start copy from here down to last EVT_BUTTON bind"""

        sizer_1 = wx.BoxSizer(wx.HORIZONTAL)

        self.list_ctrl_filePaths = wx.ListCtrl(self.Profile1, wx.ID_ANY, style=wx.LC_AUTOARRANGE | wx.LC_EDIT_LABELS | wx.LC_HRULES | wx.LC_NO_HEADER | wx.LC_REPORT | wx.LC_SORT_DESCENDING | wx.LC_VRULES)
        ...
        self.button_profile_rename = wx.Button(self.Profile1, wx.ID_ANY, "Rename")
    ...
    def profile_new(self, event):  # wxGlade: TabTemplate.<event_handler>
